...
Hacer que los iconos del personaje y los colores de la barra de vida coincidan con tus personajes.

## Pasos

1. Configura `icon` y `barColor` del personaje en el JSON del personaje.
