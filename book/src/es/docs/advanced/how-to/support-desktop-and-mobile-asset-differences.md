...
Maneje el comportamiento específico de la plataforma sin alterar el contenido mod.

## Lo que se verifica

- El modo móvil se puede alternar mediante indicadores de plataforma/desarrollador.
- El motor tiene ramas de configuración específicas para dispositivos móviles.

## Guía

- Mantenga primero el contenido compartido en rutas comunes.
